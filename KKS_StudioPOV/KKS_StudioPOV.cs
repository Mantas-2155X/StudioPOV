...
namespace KKS_StudioPOV
{
    [BepInProcess("CharaStudio")]
    [BepInPlugin(nameof(KKS_StudioPOV), nameof(KKS_StudioPOV), VERSION)]
    public class KKS_StudioPOV : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            var harmony = new Harmony(nameof(KKS_StudioPOV));
            harmony.PatchAll(typeof(KKS_StudioPOV));
        }
